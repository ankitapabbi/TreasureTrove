...
public class GameActivityTwo extends AppCompatActivity {
    ...
    private GameActivityTwo.AudioRecorder audioRecorder;
            ...
            switch (message.what) {
                case UPDATE: {
                    if (gameView.isAlive()) {
                        ...
                        alertDialog = new AlertDialog.Builder(GameActivityTwo.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (gameMode == TOUCH_MODE) {
            ...
            audioRecorder = new GameActivityTwo.AudioRecorder();
                ...
                public void run() {
                    ...
                    while (isGetVoiceRun) {
                        ...
                        if (volume > volumeThreshold) {
                            GameActivityTwo.this.gameView.jump();
    ...
    private void setNewTimer() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                GameActivityTwo.this.handler.sendEmptyMessage(UPDATE);
